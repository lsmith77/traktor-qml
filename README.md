...
| [traktor-kontrol-d2 Stem Mods](https://github.com/lsmith77/traktor-kontrol-d2/releases/tag/v0.7.0) | v0.7.0          | D2          | `qml/CSI/Common/Deck_S8Style.qml`      |
...
**D2 stem features**: stem mute (pads 1–4), Serato-style FX pads (5–8 → FX Unit 4), shift+pads toggle FX send / filter per stem, Edit button duplicates deck to sister deck (A↔C or B↔D) with auto stem split, Shift+FX knobs 1–4 vocal/instrumental crossfader (SSS), Shift+Flux toggles persistent SSS mode.
